...
export const SERVICE_PAGES = {
  distribution: {
    ...
    problemHeading: 'Every channel, working with intent.',
    problemBody:
      "For most independents, distribution grows by accident, a few listings set up years ago and left to run. The opportunity is to make it deliberate. Rather than the same rate everywhere by default, Indi positions each channel with purpose, so every one earns its place and your direct channels, your own website, phone and email, are always your guests' best offer. Connected cleanly to your PMS, priced with intent, and built around a direct-booking strategy that lowers your cost of acquisition over time. The strength isn't just the channels you're on. It's the strategy behind how you use them.",
    work: [
      ...
      ['Custom channel positioning', 'Every channel priced with intent, so your direct channels are always your guests\u2019 best offer.'],
  ...
  'revenue-management': {
    ...
    problemBody:
      'Demand shifts daily, events, weather, your comp set, the day of week, and the opportunity is to move with it. Rather than a season rate and a weekend rate with not much in between, Indi builds pricing that responds to real demand signals, so every night is priced to capture what the market will pay. It\u2019s a full-time discipline, and it\u2019s exactly what we bring to your property.',
    work: [
